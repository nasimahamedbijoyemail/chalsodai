    ...
    <div className="container py-10 pb-24 md:pb-10 max-w-2xl">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <Smartphone className={`h-6 w-6 mb-2 ${paymentMethod === 'bkash' ? 'text-primary' : 'text-muted-foreground'}`} />
            <p className="font-bold text-sm">বিকাশ পেমেন্ট</p>
            <p className="text-xs text-muted-foreground">আগে পে করুন</p>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">ডেলিভারির সময় পে করুন</p>
          </button>
        </div>
      </div>
